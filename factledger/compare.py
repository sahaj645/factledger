...
def _values_equal(raw_a: str, va: NormalizedValue, raw_b: str, vb: NormalizedValue) -> bool:
    """Compare at the precision of the less precise figure. A value rounded to a
    coarse unit and the same amount stated to more decimals in a finer one agree; two
    figures that differ in their last stated digit, like 6.5 and 6.6 per cent, do
    not."""
